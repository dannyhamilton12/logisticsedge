---
title: "FOB vs CIF: Key Differences for UK Importers"
description: "FOB vs CIF explained for UK importers. Understand cost allocation, risk transfer, insurance responsibilities, and which incoterm suits your shipments."
pubDate: 2026-04-04
author: "LogisticsEdge"
category: "trade"
tags: ["fob", "cif", "incoterms", "shipping", "international-trade", "freight"]
image: "/images/articles/fob-vs-cif-explained.jpg"
draft: false
---
...
FOB is one of the 11 [Incoterms 2020 rules](/articles/incoterms-explained-visual-uk-guide/) published by the International Chamber of Commerce (ICC). It applies exclusively to sea and inland waterway transport.
...
- **UK import customs clearance**, including the customs declaration, [import duties](/articles/import-duty-uk-complete-guide/), and import VAT
...
- **UK import [customs clearance](/articles/customs-clearance-uk-step-by-step-guide/)**, duties, and import VAT
...
Your total landed cost includes the goods price, freight, insurance, [import duty](/articles/import-duty-uk-complete-guide/), import VAT, port handling, and inland delivery. Under CIF, the first three are bundled together. Under FOB, they are separated.
...
When goods arrive in the UK, HMRC assesses [import duty](/articles/import-duty-uk-complete-guide/) based on the customs value of the goods. The UK uses the **CIF method** for customs valuation. This means:
...
Understanding how [commodity codes](/articles/uk-commodity-codes-tariff-classification-guide/) and tariff rates apply to your goods helps you quantify this impact accurately.

## Practical Tips for UK Importers

1. **Ask for both prices.** Request FOB and CIF quotes from your supplier. Compare the CIF price against the FOB price plus your own freight and insurance costs. The difference reveals the seller's mark-up on logistics.

2. **Check the insurance clause.** If buying CIF, ask the seller for the insurance certificate and confirm whether it is ICC Clause A, B, or C. If it is Clause C, arrange top-up cover independently.

3. **Factor in the full chain.** Neither FOB nor CIF covers UK port handling, customs clearance fees, or inland delivery. Budget for these separately regardless of which term you use.

4. **Consider FCA for containers.** If your goods are containerised and handed to the carrier at an inland point (such as the supplier's factory), FOB is technically incorrect — risk should transfer at the point of delivery to the carrier, not the ship's rail. FCA (Free Carrier) is the correct term for this scenario. See our [Incoterms guide](/articles/incoterms-explained-visual-uk-guide/) for the full breakdown.

5. **Document everything.** Whichever term you use, ensure your purchase order, commercial invoice, and bill of lading all reference the same Incoterm and named location. Inconsistencies cause delays at [customs clearance](/articles/customs-clearance-uk-step-by-step-guide/).

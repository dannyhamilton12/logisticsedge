---
title: "Import Duty UK: The Complete Guide to Customs Duties"
description: "Practical guide to UK import duty covering rates, calculation steps, trade agreement preferences, duty relief schemes, and common mistakes to avoid."
pubDate: 2026-04-04
author: "LogisticsEdge"
category: "customs"
tags: ["import-duty", "customs-duty", "uk-trade", "tariffs", "uk-global-tariff", "duty-relief", "trade-agreements"]
image: "/images/articles/import-duty-uk.jpg"
draft: false
---
...
Rates range from 0% to over 25%, depending on the product's commodity code and country of origin. Many goods from trade agreement countries attract 0% duty if preferential rates are claimed.

**What is the UK import duty threshold?**
Goods valued at £135 or less are exempt from customs duty. This threshold is scheduled for removal by March 2029.

**Do I pay import duty on goods from the EU?**
Potentially, yes. Since Brexit, EU goods are subject to the same tariff as goods from anywhere else. However, the EU-UK TCA offers 0% duty on goods that meet rules of origin requirements.

**What is the difference between import duty and VAT?**
Import duty is a tariff charged based on the product type and origin. Import VAT (20%) is charged on the customs value plus any duty owed. They are separate charges, both collected by HMRC.
